...
<html lang="en">
    <head>
        ...
        <style>
            ...
            /* Styling for clickable student profile links */
            .profile-link {
                color: #2D2D2D;
        ...
        <div class="container my-5">
            <div class="p-4 mb-4 header-panel shadow d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="mb-0 text-white-50">List of all registered student profiles in the database</p>
                </div>
            ...
            <div class="table-container shadow p-3">
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <% 
                                // Fetching profile data array from ProfileServlet (doGet)
                            ...
                            <tr>
                                ...
                                <td class="fw-semibold">
                                    <a href="ProfileServlet?action=viewSingle&id=<%= p.getStudentID() %>" class="text-decoration-none profile-link fw-bold">
                                        <%= p.getName() %>
                                    </a>
                                </td>
                                ...
                                <td class="text-center" style="white-space: nowrap;">
                                    <a href="ProfileServlet?action=edit&id=<%= p.getStudentID() %>" 
                                       class="btn btn-sm btn-warning px-3 rounded-pill shadow-sm me-1 fw-semibold">
                            ...
                            <tr>
                                <td colspan="7" class="text-center py-5 text-muted">
                                    ...
                                    No profile records found in the database.
                                </td>
                            </tr>
                            <% 
                                } 
